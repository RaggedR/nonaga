...
## Model Architecture
- ResNet: 6x7x7 input, 64 channels, 4 res blocks (~570K params)
- Three heads: piece policy (294), tile policy (2401), value (-1 to +1)
- Two-ply turn decomposition: MCTS searches piece moves and tile moves separately
